...
subtitle: "[Material](https://github.com/dataAt/introducao-analise-de-dados)"
author: "<br>Felipe Carvalho<br>Felipe Menino"
date: "<br><br>02 de agosto de 2019"
output:
...
## Vetores são atômicos, ou seja, só aceitam um tipo de classe:
<br>
--
...
--
## Listas não são atômicas, ou seja, aceitam diversos tipos de classes:
--
...
<br><br>
## Todos os tipos primitivos em R são considerados como vetores:
...
<br>
### Template do [Adriano](https://github.com/AdrianoPereira/project-cap394/blob/master/src/EDA.ipynb)
<br>
### Dúvidas?

...
- .font120[Revisão da linguagem R `r anicon::faa("r-project", animate = 'float', speed = 'slow', color = 'steelblue')`]

- .font120[Pacote Tidyverse `r anicon::cia("./images/2_r_img/logo_tidyverse_menor.png", animate = 'float', speed = 'slow')`]
...
# .center.font170[Pacote Tidyverse `r knitr::include_graphics("./images/2_r_img/logo_tidyverse.png")`]
---

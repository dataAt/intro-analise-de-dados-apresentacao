...
<!-- Introdução falar sobre a motivação de aprender R e Python. Falar da questão R VS Python e este cenário passando para R e Python -->
<!-- No mundo real, problemas precisam ser resolvidos! -->
<!-- Crescimento do cenário de 'data science' (Rever o que o Rafael fala em seu curso de introdução) -->
...
<!-- ToDo: Verificar melhor tamanho para este texto -->
.pull-left[
...
<!-- ToDo: Adicionar mais um exemplo aqui ? Ao invés de um único código corrido -->
```{r, fig.height=5}
  valor_a <- 21
  valor_b <- 42
...
<!-- ToDo: Achei a forma com que isto está escrito um pouco estranha -->
...
<!-- ToDo -->
<!-- Acho legal colocar aqui, porém está meio fora de contexto, talvez deveria ir para o final -->
<!-- Pode ate manter, dependendo da estratégia adotada para a apresentação, mas este gráfico é ok ficar aqui ? -->
...
<!-- ToDo: Será que os exemplos desta seção estão simples de entender ? -->
# .center[.font170[Visualização de dados]]

---
# Pacote de visualização - .bold[ggplot2]

<!-- ToDo: Nesta parte aqui pensei em colocar primeiro sobre o grammar of graphics e que suas descrições permitiram a implementação de vários pacotes, a citar o ggplot2 e o plotnine. Acho que isto deixa um gancho para falarmos dos pacotes e então fazer a apresentação da parte de visualização de dados  -->
...
<!-- ToDo: Falar de extensões é algo legal ? pq estamos utilizando o plotnine por conta da compatibilidade interessante que ele traz entre o ambiente R e Python, talvez as extensões quebrem um pouco esta ideia, o que acha ? -->
---

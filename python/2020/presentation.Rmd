...
<!-- `r anicon::faa("r-project", animate = 'pulse', speed = 'slow', color = 'steelblue')`] -->
...
O pandas fornece uma infinidade de métodos para a seleção e filtro dos dados. Alguns podem ser bastante úteis durente o processo de análise de dados com Python.
...
.center[
  .content-box-gray[.bold[Dica: Filtragem e substituição]]
]
...
.content-box-gray[.bold[Algumas funções de agregação]]
...
.pull-right[
  Verificando o tipo de dado retornado

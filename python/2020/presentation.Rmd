...
.center[
  Com o Pandas é possível não só realizar o processamento dos dados, como também todo o processo de leitura e escrita. A biblioteca suporta diversos formatos, sendo alguns deles `CSV`, `JSON` e `Excel`.
]
